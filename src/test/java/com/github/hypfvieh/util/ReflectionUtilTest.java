...
public class ReflectionUtilTest extends AbstractBaseUtilTest {
    ...
    public void testGetAllDeclaredStaticMethods() {
        ...
        assertTrue("Expected no declared static methods in " + TestClass1.class + " but got: " + allDeclaredFields, allDeclaredFields.isEmpty());

        allDeclaredFields = ReflectionUtil.getAllDeclaredStaticMethods(TestClass2.class, "$jacocoData", "registerNatives");
        assertTrue("Expected no declared static methods in " + TestClass2.class + " but got: " + allDeclaredFields, allDeclaredFields.isEmpty());
    }
